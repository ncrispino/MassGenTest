...
class WorkspaceStructureSection(SystemPromptSection):
    ...
    def build_content(self) -> str:
        ...
        if self.use_two_tier_workspace:
            ...
            content_parts.append("- If it's code: include all files needed to execute it")
            content_parts.append("- If it's a website: include HTML, CSS, JS, and assets together\n")
            content_parts.append("Think of `deliverable/` as a standalone package that voters can immediately use without needing files from `scratch/`.\n")
